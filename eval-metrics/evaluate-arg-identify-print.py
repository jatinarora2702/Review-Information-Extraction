...
# Utility for measuring the overall F1-Score, Precision, Recall and Accuracy for Argument Identification task, at a given model checkpoint
...
def evaluate(num):
	...
	f = codecs.open('../results/model3-data1/results-arg-identify-all.txt', 'a', 'utf-8')
